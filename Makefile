...
TESTS=trols_munger_ui/tests/test_health.py \
  trols_munger_ui/tests/test_google.py \
  trols_munger_ui/tests/test_last_update.py \
  trols_munger_ui/tests/test_munger.py \
  trols_munger_ui/tests/test_players.py \
  trols_munger_ui/tests/test_sections.py \
  trols_munger_ui/tests/test_stats.py \
  trols_munger_ui/tests/test_teams.py \
  trols_munger_ui/tests/test_utils.py

tests:
	PYTHONPATH=$(PYTHONPATH) TROLSUI_CONF="test_config.py" \
  $(shell which py.test) -vv --exitfirst --cov-config .coveragerc \
  --cov trols_munger_ui --junitxml junit.xml -sv $(TESTS)
